                        ...
                        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                            ...
                            <div>
                                <div className="lg:w-[570px]">
                                    ...
                                    We specialize in multi-family residential, commercial cleaning. 
                                    </h1>
                                    <p className="text__para"> 
                                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. natus quaerat cumque fugit, 
                                        perspicatis cum nemo aperiam, aut quia earum amet architecto, modi odio. 
                                ...
                                lg:gap-[30px]">
                                    ...
                                    <div>
                                        ...
                                        <p className="text__para">Areas</p>
                                    </div>
                    ...
                    <div className="container">
                        <div className="lg:w-[470px] mx-auto">
                            <h2 className="heading text-center">
                                Providing the best professional cleaning services
                            </h2>
                            <p className="text__para text-center">
                                Our cleaning service offers exceptional residential and commercial cleaning services,
                      ...
                      <div className="py-[30px] px-5">
                            ...
                            <div className="mt-[30px]">
                                ...
                                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                                    Our team of professionals pays attention to every detail, ensuring a thorough 
                                    and spotless clean.
                                </p>
